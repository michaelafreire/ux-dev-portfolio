...
function BestPetsitter() {
  ...
  return (
    <div id="best-petsitter">
      <ProjectDescription name="Best Petsitter" description="lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum"/>

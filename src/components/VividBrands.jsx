...
function VividBrands() {
  ...
  return (
    <div id="vivid-brands">
      <ProjectDescription name="Vivid Brands" description="lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum"/>

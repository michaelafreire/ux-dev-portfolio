...
function DropDownMenu(){
  <div className="space-y-1 px-2 pb-3 pt-2">
    <a href="#" className="block rounded-md bg-gray-900 px-3 py-2 text-base font-medium text-white" aria-current="page">About me</a>
    <a href="#" className="block rounded-md px-3 py-2 text-black text-sm font-main hover:bg-dark-gray hover:text-white">About me</a>
    <a href="#" className="block rounded-md px-3 py-2 text-black text-sm font-main hover:bg-dark-gray hover:text-white">Projects</a>
    <a href="#" className="block rounded-md px-3 py-2 text-black text-sm font-main hover:bg-dark-gray hover:text-white">Contact</a>
  </div>
}
